  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        {/* Main Job Card */}
        <div className={`md:col-span-8 p-8 rounded-3xl ${isDarkMode ? 'glass' : 'glass-light shadow-xl'}`}>
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <div>
              ...
              <p className={`text-lg font-medium ${isDarkMode ? 'text-slate-300' : 'text-slate-700'}`}>Financial Assets Intern</p>
            </div>
          ...
          <ul className={`space-y-4 mb-8 ${isDarkMode ? 'text-slate-400' : 'text-slate-600'}`}>
            {[
        ...
        {/* Impact Stat 1 */}
        <div className={`md:col-span-4 p-8 rounded-3xl flex flex-col items-center justify-center text-center group ${isDarkMode ? 'bg-navy-light/50 border border-white/5 hover:border-cyber/50' : 'bg-white shadow-lg border border-slate-100 hover:border-cyber'} transition-all`}>
          <div className="text-6xl font-heading font-extrabold text-cyber mb-2 group-hover:scale-110 transition-transform">35%</div>
          <p className={`text-sm font-mono uppercase tracking-widest ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Efficiency Increase</p>
          <p className="mt-4 text-sm opacity-80">Optimized asset records and improved search architecture for the tracking database.</p>
        </div>

        {/* Leadership Card */}
        <div className={`md:col-span-6 p-8 rounded-3xl ${isDarkMode ? 'glass' : 'glass-light shadow-xl'}`}>
          <h3 className={`text-xl font-heading font-bold mb-6 ${isDarkMode ? 'text-white' : 'text-navy'}`}>Leadership & Academic Involvement</h3>
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-bold">Class Delegate, IQS</h4>
            ...
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-bold">Peer Tutor, IQS</h4>
        ...
        {/* Impact Stat 2 */}
        <div className={`md:col-span-6 p-8 rounded-3xl flex flex-col items-center justify-center text-center group ${isDarkMode ? 'bg-violet/10 border border-violet-500/20 hover:border-violet-500/50' : 'bg-slate-50 shadow-lg border border-slate-200 hover:border-violet-500'} transition-all`}>
          ...
          <p className={`text-sm font-mono uppercase tracking-widest ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Investment Proposals</p>
